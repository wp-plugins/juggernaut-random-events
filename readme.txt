...
\margl1440\margr1440\vieww10800\viewh10500\viewkind0
\deftab720
\pard\pardeftab720
...
== Description ==\
\
Create random events anywhere on your website to get your visitors excited while increasing your pageviews, time on site, and customer loyalty. You can give away anything you want to rewards visitors with like a free report, product, software license, or coupon code with Juggernaut Random Events. You also get to choose the how often your random events are triggered and what pages they will show up on.\
\
== Installation ==\
\
1. Upload `random_event` to the `/wp-content/plugins/` directory\
2. Activate the plugin through the 'Plugins' menu in WordPress\
3. Configure Random Even through the settings tab.\
\
== Frequently Asked Questions ==\
\
= How can I give my customers a coupon to my store? =\
\
Simply create a page to display the coupon and set up the Random Event Link URL to point there.\
\
== Screenshots ==\
\
1. The admin dashboard is easy to understand and configure, allowing you to quickly set up and start running your new Random Event in minutes flat. \
\
2. the pop up window is clean and easy to read, eye grabbing and closable. \
\
== Changelog ==\
\
= 1.0 =\
...
added destination URL for prize ( squeze page )\
...
\
= 1.3 =\
Introducing Random Event from Juggernaut Plugins\
\
\
}